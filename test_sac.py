...
if __name__ == '__main__':
    ...
    state = env.reset()
    chkpt_dir = 'Modelos_Finales/Pendulo_1/Modelo_con_entropia_final'
    ...
    plot_episode_variables(t, pos_list, vel_list, ang_list, ang_vel_list, accion, csv_file="sac_4_pendulo_3_tati.csv")